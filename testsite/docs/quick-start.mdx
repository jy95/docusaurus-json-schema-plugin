...
<Tabs>
<TabItem value="docusaurus-ts" label="Docusaurus Typescript" default>
...
<TabItem value="docusaurus-js" label="Docusaurus JavaScript">

```jsx title="/docs/example.mdx"
import CodeBlock from '@theme/CodeBlock';
import Schema from "@site/static/schemas/mySuperSchema.json";
// In JS only projects, you can't enjoy nice imports for 3rd libs without @docusaurus/module-type-aliases
